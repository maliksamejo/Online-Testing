...
<div class="col-md-6">
                                            <div class="form-inline" >
												...
												<div class="form-group">
                                                    ...
                                                    <p class="form-control-static">Enter Roll No:</p>
                                                </div></td>
                                                <td><div class="form-group">
                                                
                                                    <input type="text"   name="roll_no" id="seat" placeholder="" required>
                                                </div></td>
...
$show ="SELECT * FROM stud_info where roll_no='".$roll_no."' " ;
...
$show ="SELECT * FROM  ots_result where roll_no='".$roll_no."' " ;
$result= mysql_query($show);
$row=mysql_num_rows($result);
$id=0;
